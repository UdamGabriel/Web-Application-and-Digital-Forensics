...
> Do not upload credentials, live session identifiers, personal data, sensitive local files, unredacted configuration secrets, or unnecessarily dangerous proof-of-concept material.

---

## Evidence and Documentation Standard

Each lab folder should contain a focused `README.md` with:
...
5. Root cause
6. High-level testing procedure
7. Sanitized evidence
8. Security impact
9. Mitigation implemented
10. Retest result
11. Lessons learned
12. References
...
```text
evidence/
├── 01-initial-application-state.png
├── 02-test-request-redacted.png
├── 03-vulnerable-response-redacted.png
├── 04-code-before-remediation.png
├── 05-code-after-remediation.png
└── 06-retest-result.png
```

Evidence should be cropped to the relevant area and reviewed before publication. Secrets, usernames, paths, tokens, cookies, personal information, and unrelated browser content should be removed or masked.
...
- **Affected component:** [Page, endpoint, function, or parameter]
- **Risk rating:** [Critical, High, Medium, Low, or Informational]
- **Status:** [Validated, Mitigated, or Retested]
- **Root cause:** [Brief technical explanation]
- **Impact:** [Realistic effect in the lab context]
- **Evidence:** [Link to sanitized screenshot or output]
- **Remediation:** [Control implemented or recommended]
- **Retest result:** [Resolved, Partially Resolved, or Open]
```

Risk ratings should be based on demonstrated impact, required access, exploitability, and the sensitivity of affected resources. Avoid assigning a severe rating solely because a vulnerability category is commonly considered dangerous.
...
> Replace the placeholders above before publishing this repository.
